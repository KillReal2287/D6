...
@Component
public class CheckInRepositoryImpl implements BoardingPassRepository {

    @Override
    @SneakyThrows
    public CheckIn generateBoardingPasses(String ticketNo) {
        ...
        return new CheckIn(seat, boarding);
    }
}